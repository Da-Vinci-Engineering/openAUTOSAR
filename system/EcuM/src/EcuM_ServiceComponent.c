...
Std_ReturnType EcuM_ShutdownTarget_GetLastShutdownTarget(EcuM_StateType* target, uint8_t* mode) {
	return E_NOT_OK;
}

Std_ReturnType EcuM_ShutdownTarget_GetShutdownTarget(EcuM_StateType* target, uint8_t* mode) {
	return EcuM_GetShutdownTarget(target, (uint8_t*)mode);
}

Std_ReturnType EcuM_ShutdownTarget_SelectShutdownTarget(EcuM_StateType target, uint8_t mode) {
	return EcuM_SelectShutdownTarget(target, (uint8_t)mode);
}
