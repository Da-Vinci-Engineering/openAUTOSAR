 ...
 *******************************************************************/
#define DEM_MAX_NUMBER_AGING_PRI_MEM                5
#define DEM_MAX_NR_OF_CLASSES_IN_FREEZEFRAME_DATA   5
#define DEM_DID_IDENTIFIER_SIZE_OF_BYTES            5
#define DEM_FREEZEFRAME_DEFAULT_VALUE               5
#define DEM_MAX_NR_OF_RECORDS_IN_FREEZEFRAME_DATA   5
